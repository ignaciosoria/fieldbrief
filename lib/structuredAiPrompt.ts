...
9a. **COMMERCIAL SIGNALS (do not omit when present):** When the note mentions any of the following, **include a dedicated line** (one category per line when possible; concrete nouns and specifics — not hollow slogans):
   ...
   - **Main problem / pain** — the focal agronomic or operational issue (e.g. fruit size, yield, quality, pest pressure, logistics). **Not** generic "challenges" — name the **specific** issue from the note.
   - **Decision barrier** — what blocks or slows the purchase (e.g. needs trial results, budget pending, partner approval, risk concerns, competitor still in evaluation).
