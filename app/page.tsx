...
export default function Home() {
  ...
  if (status === 'unauthenticated') {
    return (
      <main className="flex min-h-[100dvh] flex-col bg-white px-6 pb-10 text-[#111111] antialiased sm:px-8 sm:pb-12 sm:max-w-[430px] sm:mx-auto sm:shadow-[0_0_40px_rgba(0,0,0,0.08)] sm:border-x sm:border-[#e5e7eb]">
  ...
  return (
    <main className="flex min-h-screen flex-col bg-white text-[#111111] antialiased select-none sm:max-w-[430px] sm:mx-auto sm:shadow-[0_0_40px_rgba(0,0,0,0.08)] sm:border-x sm:border-[#e5e7eb]">
